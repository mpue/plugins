/*
  ==============================================================================
    ...
    PresetBar.h
    SA-1 preset selector strip: prev / combo / next / save / del / init.
...
namespace SA1
{
    ...
    public:
        explicit PresetBar (PresetManager& pm) : presetManager (pm)
        {
            ...
            combo.setTextWhenNothingSelected ("Kit");
        ...
        void resized() override
        {
            ...
            r.removeFromLeft (4);
            combo   .setBounds (r.removeFromLeft (240));
            r.removeFromLeft (4);
    ...
    private:
        void rebuildCombo()
        {
            ...
            {
                combo.addSeparator();
                combo.addSectionHeading ("User Kits");
        ...
        void showSaveDialog()
        {
            auto* aw = new juce::AlertWindow ("Save Kit",
                                              "Enter a name for this drum kit:",
        ...
        void showDeleteDialog()
        {
            ...
            juce::AlertWindow::showAsync (juce::MessageBoxOptions()
                ...
                .withTitle ("Delete Kit")
                .withMessage ("Delete user kit \"" + current + "\"?")
                .withButton ("Delete")
                .withButton ("Cancel"),
