/*
  ==============================================================================
    ...
    PresetBar.h
    ARP-1 preset selector strip: prev / combo / next / save / del / init.
...
namespace ARP1
{
    ...
    public:
        ...
        void resized() override
        {
            ...
            r.removeFromLeft (4);
            nextBtn .setBounds (r.removeFromRight (28));
            r.removeFromRight (10);
            initBtn .setBounds (r.removeFromRight (52));
            r.removeFromRight (4);
            deleteBtn.setBounds (r.removeFromRight (52));
            r.removeFromRight (4);
            saveBtn .setBounds (r.removeFromRight (56));
            r.removeFromRight (10);
            combo   .setBounds (r);
        }
    ...
    private:
        ...
        void showSaveDialog()
        {
            auto* aw = new juce::AlertWindow ("Save Preset",
                                              "Enter a name for this arpeggio:",
