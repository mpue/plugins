/*
  ==============================================================================
    ...
    PresetBar.h
    Preset selector strip: previous, combo, next, save, delete, init.
    Talks to a PresetManager. Lives at the top of the editor.
...
public:
    explicit PresetBar (PresetManager& pm) : presetManager (pm)
    {
        ...
        configureSquareButton (prevBtn,  "<");
        configureSquareButton (nextBtn,  ">");
        configureWideButton   (saveBtn,  "Save");
        configureWideButton   (deleteBtn,"Del");
        configureWideButton   (initBtn,  "Init");
...
private:
    static void configureSquareButton (juce::TextButton& b, const juce::String& text)
    {
        b.setButtonText (text);
    }

    static void configureWideButton (juce::TextButton& b, const juce::String& text)
    {
        b.setButtonText (text);
    }
