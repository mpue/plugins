...
class CH1AudioProcessor  : public juce::AudioProcessor
{
public:
    CH1AudioProcessor();
    ~CH1AudioProcessor() override;
    ...
    ChorusEngine&                       getEngine() noexcept      { return engine; }
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (CH1AudioProcessor)
};
