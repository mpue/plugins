                                             ...
                                             Slider & 	slider )
{
    ...
    Image myStrip = ImageCache::getFromMemory (BinaryData::knob_128_png, BinaryData::knob_128_pngSize);
    ...
    {
        Path filledArc;
        filledArc.addPieSegment (rx+2, ry+2, rw-1, rw-1, rotaryStartAngle, angle, thickness);
                                        ...
                                        bool isMouseOverButton, bool isButtonDown)
{
    ...
    float fontSize = jmin (18.0f, (float)button.getHeight());
...
void TrioLookAndFeel::drawLabel (Graphics& g, Label& label)
{
    ...
    //g.fillAll (label.findColour (Label::textColourId));
    //
	...
	GroupComponent& group)
{
	...
	g.fillRect(roundToInt(x + textX), 3,
		roundToInt(textW),
		roundToInt(textH+2));
